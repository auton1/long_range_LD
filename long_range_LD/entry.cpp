...
void entry::make_typed_float_vector(vector<char> &out, const string &in, int number )
{
	...
	float value;
	char missing[4] = {0x01, 0x00, static_cast<char>(0x80), 0x7F};
	char end[4] = {0x02, 0x00, static_cast<char>(0x80), 0x7F};
...
{
	static char missing_float[4] = {0x01, 0x00, static_cast<char>(0x80), 0x7F};
	static char missing_int1 = 0x80;
	static char missing_int2[2] = {0x00, static_cast<char>(0x80)};
	static char missing_int3[4] = {0x00, 0x00, 0x00, static_cast<char>(0x80)};
...
{
	static char end_float[4] = {0x02, 0x00, static_cast<char>(0x80), 0x7F};
	static char end_int1 = 0x81;
	static char end_int2[2] = {0x01, static_cast<char>(0x80)};
	static char end_int3[4] = {0x01, 0x00, 0x00, static_cast<char>(0x80)};
